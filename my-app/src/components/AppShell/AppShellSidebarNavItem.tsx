...
import {
  LayoutDashboard, BarChart2, BarChart3, PieChart, Bell, ChefHat, CreditCard, QrCode,
  Map, MapPin, Grid3x3, CalendarDays, CalendarCheck, UtensilsCrossed, FlaskConical, Package,
  Trash2, Zap, Banknote, Receipt, Gift, Percent, Tag, Building2, Users,
  ShieldCheck, Timer, HardDrive, Settings, Sliders, Key, Layers,
  type LucideProps,
} from "lucide-react";
