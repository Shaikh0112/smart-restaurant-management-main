...
export const APP_ROUTES = {
  ...
  // Manager Routes
  MANAGER_DASHBOARD: MANAGER_ROUTES.DASHBOARD,
  MANAGER_REPORTS: MANAGER_ROUTES.REPORTS,
  MANAGER_RESERVATIONS: MANAGER_ROUTES.RESERVATIONS,
  MANAGER_CREDENTIALS: MANAGER_ROUTES.CREDENTIALS,
  MANAGER_MENU: MANAGER_ROUTES.MENU,
  MANAGER_INVENTORY: MANAGER_ROUTES.INVENTORY,
  MANAGER_COUPONS: MANAGER_ROUTES.COUPONS,
  MANAGER_SETTINGS: MANAGER_ROUTES.SETTINGS,
  MANAGER_STAFF: MANAGER_ROUTES.STAFF,
  MANAGER_AUDIT: MANAGER_ROUTES.AUDIT,
  MANAGER_SHIFT: MANAGER_ROUTES.SHIFT,
  MANAGER_BACKUP: MANAGER_ROUTES.BACKUP,
  MANAGER_QR: MANAGER_ROUTES.QR,
  MANAGER_LIST_HOTEL: MANAGER_ROUTES.LIST_HOTEL,

  // Cashier Routes
  CASHIER_DASHBOARD: CASHIER_ROUTES.HOME,
...
export const APP_SHELL_NAV_GROUPS: AppShellNavGroup[] = [
  // ================= ADMIN & OWNER =================
  {
    ...
    items: [
      ...
      { id: "owner-dashboard", label: "Analytics Dashboard", href: APP_ROUTES.MANAGER_DASHBOARD, iconName: "BarChart3", allowedRoles: ["MANAGER"] },
      ...
      { id: "owner-reports", label: "Reports & Analytics", href: APP_ROUTES.MANAGER_REPORTS, iconName: "PieChart", allowedRoles: ["MANAGER"] },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "owner-reservations", label: "Advance Reservations", href: APP_ROUTES.MANAGER_RESERVATIONS, iconName: "CalendarCheck", allowedRoles: ["MANAGER"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "owner-menu", label: "Menu & Item Master", href: APP_ROUTES.MANAGER_MENU, iconName: "UtensilsCrossed", allowedRoles: ["MANAGER"] },
      ...
      { id: "owner-inventory", label: "Stock Inventory", href: APP_ROUTES.MANAGER_INVENTORY, iconName: "Package", allowedRoles: ["MANAGER"] },
      ...
      { id: "owner-coupons", label: "Coupons & Discounts", href: APP_ROUTES.MANAGER_COUPONS, iconName: "Tag", allowedRoles: ["MANAGER"] },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "owner-settings", label: "Restaurant Settings", href: APP_ROUTES.MANAGER_SETTINGS, iconName: "Sliders", allowedRoles: ["MANAGER"] },
      
      { id: "admin-staff", label: "Staff Management", href: APP_ROUTES.ADMIN_STAFF, iconName: "Users", allowedRoles: ["ADMIN"] },
      { id: "owner-staff", label: "Staff Management", href: APP_ROUTES.MANAGER_STAFF, iconName: "Users", allowedRoles: ["MANAGER"] },
      
      { id: "owner-credentials", label: "Staff Credentials", href: APP_ROUTES.MANAGER_CREDENTIALS, iconName: "Key", allowedRoles: ["MANAGER"] },
      
      { id: "admin-audit", label: "Permissions & Audit Logs", href: APP_ROUTES.ADMIN_AUDIT, iconName: "ShieldCheck", allowedRoles: ["ADMIN"] },
      { id: "owner-audit", label: "Permissions & Audit Logs", href: APP_ROUTES.MANAGER_AUDIT, iconName: "ShieldCheck", allowedRoles: ["MANAGER"] },
      
      { id: "admin-shift", label: "Shift & Day-Close", href: APP_ROUTES.ADMIN_SHIFT, iconName: "Timer", allowedRoles: ["ADMIN"] },
      { id: "owner-shift", label: "Shift & Day-Close", href: APP_ROUTES.MANAGER_SHIFT, iconName: "Timer", allowedRoles: ["MANAGER"] },
      ...
      { id: "owner-backup", label: "Data Backup & Restore", href: APP_ROUTES.MANAGER_BACKUP, iconName: "HardDrive", allowedRoles: ["MANAGER"] },
      
      { id: "admin-qr-gen", label: "Table QR Generator", href: APP_ROUTES.ADMIN_QR, iconName: "QrCode", allowedRoles: ["ADMIN"] },
      { id: "owner-qr-gen", label: "Table QR Generator", href: APP_ROUTES.MANAGER_QR, iconName: "QrCode", allowedRoles: ["MANAGER"] },
      
      { id: "admin-list-hotel", label: "List Your Hotel", href: APP_ROUTES.ADMIN_LIST_HOTEL, iconName: "MapPin", allowedRoles: ["ADMIN"] },
      { id: "owner-list-hotel", label: "List Your Hotel", href: APP_ROUTES.MANAGER_LIST_HOTEL, iconName: "MapPin", allowedRoles: ["MANAGER"] },
    ],
  },
  // ================= SUPER ADMIN =================
  {
