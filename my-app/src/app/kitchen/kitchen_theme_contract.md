...
- `--success-bg`: Success background/tint color
- `--warning`: Warning status color
- `--warning-bg`: Warning background/tint color
- `--danger`: Danger/Error status color
- `--danger-bg`: Danger/Error background/tint color
- `--info`: Info status color
- `--info-bg`: Info background/tint color
