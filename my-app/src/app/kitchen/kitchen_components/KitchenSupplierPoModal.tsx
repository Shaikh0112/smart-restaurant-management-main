...
export function KitchenSupplierPoModal({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-page/80 backdrop-blur-sm p-4 backdrop-blur-xs animate-fadeIn">
      <div className="w-full max-w-2xl rounded-2xl border border-border bg-card shadow-2xl overflow-hidden max-h-[95vh] flex flex-col print:m-0 print:w-full print:max-w-none print:border-none print:shadow-none p-4">
        <PrintableWrapper printTitle={`Purchase Order ${poNumber}`} onClose={onClose}>
          {/* Printable Purchase Order Content */}
          <div className="flex flex-col gap-6 overflow-y-auto bg-card text-text-primary p-2">
