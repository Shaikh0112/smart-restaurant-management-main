// RESPONSIBILITY: Mock data and constants for roles_constants
import type { SuperAdminUser, Permission, AdminRole } from "@/app/super-admin/super-admin_types/roles_types";
