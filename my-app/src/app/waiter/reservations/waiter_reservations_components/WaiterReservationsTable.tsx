              ...
              pageItems.map((res) => {
                ...
                return (
                  <React.Fragment key={res.id}>
                    {/* Main data row */}
                    <tr className="border-b border-border last:border-0 odd:bg-card even:bg-page hover:bg-primary/5 transition-colors active:scale-95">
                      ...
                      <td className="px-4 py-3">
                        {res.status === STATUS_CONFIRMED && (
                          <button
                            ...
                            className="flex items-center gap-1 rounded-lg border border-danger/40 px-2.5 py-1 text-[12px] font-medium text-danger hover:bg-danger-bg disabled:cursor-not-allowed disabled:opacity-50 transition-colors active:scale-95"
                          >
                            {isCancelling ? (
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="rounded-lg bg-danger px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-danger/80 transition-colors active:scale-95"
                              >
                                Yes, Cancel
                              </button>
                              <button
                                onClick={handleDismiss}
                                className="rounded-lg border border-border px-3 py-1.5 text-[12px] font-semibold text-text-primary hover:bg-card transition-colors active:scale-95"
                              >
                                Keep
                              </button>
                            </div>
