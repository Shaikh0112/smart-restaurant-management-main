      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          ...
          <button
            ...
            className="rounded-lg p-1.5 text-text-secondary transition-colors hover:bg-page active:scale-95"
          >
            <X size={18} />
          </button>
        </div>
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 text-[14px] font-semibold text-white transition-colors hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-60 active:scale-95"
          >
