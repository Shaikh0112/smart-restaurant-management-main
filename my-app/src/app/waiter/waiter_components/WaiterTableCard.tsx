    ...
    >
        ...
        <div className="flex items-center gap-1">
          ...
          {onQrClick && (
            <button
              ...
              className="flex h-6 w-6 items-center justify-center rounded-lg border border-border bg-page text-text-secondary transition-colors hover:border-primary hover:bg-primary/10 hover:text-primary active:scale-95"
            >
              <QrCode size={13} />
            </button>
          )}
      ...
      {(table.status === "CLEANING" || table.status === "DIRTY") && onMarkCleaned && (
        <button
          ...
          className="mt-1 flex w-full items-center justify-center gap-1.5 rounded-lg bg-success py-1.5 text-[10px] font-extrabold text-white shadow-md hover:bg-success active:scale-95 transition-all"
        >
          <Sparkles size={14} />
