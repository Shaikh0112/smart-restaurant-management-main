  ...
  if (cart.length === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-2 py-12 text-center">
        <ShoppingCart size={18} className="text-text-disabled" aria-hidden="true" />
              ...
              <div className="mt-1 flex flex-wrap gap-1">
                {QUICK_TAGS.map(tag => (
                  <button
                    ...
                    className="rounded bg-surface-hover px-1.5 py-0.5 text-[10px] text-text-secondary transition-colors hover:bg-primary/20 hover:text-primary active:scale-95"
                  >
                    +{tag}
                  </button>
                ))}
