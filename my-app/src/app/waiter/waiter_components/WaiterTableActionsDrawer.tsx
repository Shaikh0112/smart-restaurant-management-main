            ...
            <div className="flex gap-2">
              ...
              {onViewQr && table && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3 py-3 text-[13px] font-semibold text-primary transition-colors hover:bg-primary/20 active:scale-95"
                >
              ...
              {mergeCandidates.length === 0 ? (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-md bg-primary px-3 py-2 text-[12px] font-semibold text-white transition-colors hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-40 active:scale-95"
                  >
                    Merge
                  </button>
                </div>
