...
import { recordOrderEvent } from "@/app/waiter/waiter_utils/waiter_orderEventService";
...
export function WaiterReadyQueue(): React.JSX.Element | null {
  ...
  return (
    <div className="mb-6 rounded-2xl border border-success/30 bg-success/5 p-4 shadow-sm animate-in fade-in">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <Sparkles className="h-5 w-5 text-success animate-bounce" />
            ...
            <div>
              <div className="flex items-center justify-between border-b border-border/60 pb-2 mb-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-success px-2.5 py-1 text-xs font-bold text-white hover:bg-success transition-colors shadow-sm active:scale-95"
                >
                ...
                {group.items.map((item, idx) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="rounded bg-success/10 px-2 py-0.5 text-[11px] font-bold text-success hover:bg-success hover:text-white transition-colors active:scale-95"
                    >
                      Serve
                    </button>
                  </div>
