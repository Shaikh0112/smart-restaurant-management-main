      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/50 pb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-text-secondary">Today's active cash till & digital collection metrics</p>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg border border-danger/40 bg-danger-bg px-3 py-1.5 text-xs font-bold text-danger hover:bg-danger/20 motion-safe:transition-all shadow-xs"
        >
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-surface p-3">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-xs font-semibold text-text-secondary uppercase">Cash Collected</span>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-surface p-3">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-xs font-semibold text-text-secondary uppercase">UPI / QR Sales</span>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-surface p-3">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-xs font-semibold text-text-secondary uppercase">Card POS</span>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-surface p-3">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-xs font-semibold text-text-secondary uppercase">Total Net Sales</span>
