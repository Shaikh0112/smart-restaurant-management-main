    ...
    <div className="fixed inset-0 z-[9990] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="flex h-full max-h-[600px] w-full max-w-2xl flex-col rounded-2xl bg-surface text-text-primary shadow-2xl border border-border animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-b border-border p-4 sm:p-5">
          ...
          <button
            onClick={onClose}
            className="rounded-xl p-2 text-text-muted hover:bg-page hover:text-text-primary motion-safe:transition-colors"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
          ...
          {activeAlerts.length === 0 ? (
            ...
            activeAlerts.map((alert) => {
              ...
              return (
                <div
                  key={alert.id}
                  className="flex flex-col gap-3 rounded-2xl border border-border p-4 bg-page/60 shadow-xs hover:border-border/80 motion-safe:transition-all"
                >
                  ...
                  <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-border/40">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-blue-500/10 border border-blue-500/30 py-2 px-3 text-xs font-extrabold text-blue-400 hover:bg-blue-500/20 active:scale-95 disabled:opacity-40 motion-safe:transition-all shadow-xs"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-purple-500/10 border border-purple-500/30 py-2 px-3 text-xs font-extrabold text-purple-400 hover:bg-purple-500/20 active:scale-95 disabled:opacity-40 motion-safe:transition-all shadow-xs"
                    >
        ...
        <div className="flex items-center justify-between border-t border-border p-4 bg-page/40">
          ...
          <button
            onClick={onClose}
            className="rounded-xl bg-surface border border-border px-4 py-2 text-xs font-bold text-text-primary hover:bg-page motion-safe:transition-colors"
          >
            Close
          </button>
        </div>
