...
export function CashierOrderSummary({
  ...
  onProceedToPayment,
  isProcessing = false,
}: CashierOrderSummaryProps & { isProcessing?: boolean }) {
    ...
    <div className="flex flex-col gap-5">
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-border bg-primary/5">
              <th className="px-4 py-2.5 text-xs font-semibold uppercase tracking-wide text-text-secondary">
                Item
              </th>
              <th className="px-3 py-2.5 text-center text-xs font-semibold uppercase tracking-wide text-text-secondary">
                Qty
              </th>
            ...
            {cartItems.map((item, idx) => (
              ...
              >
                <td className="px-4 py-2.5">
                  ...
                  {item.notes && (
                    <p className="text-xs italic text-text-secondary">{item.notes}</p>
                  )}
                </td>
      ...
      <div className="flex items-center justify-between gap-3 rounded-lg border border-border bg-card px-4 py-3">
        ...
        <button
          ...
          className={[
            "relative h-6 w-11 shrink-0 rounded-full motion-safe:transition-colors duration-200",
      ...
      <button
        ...
        className={[
          "flex w-full items-center justify-center gap-2 rounded-md bg-primary px-5 py-3",
          "text-sm font-semibold text-white",
          "motion-safe:transition-colors duration-150 hover:bg-primary-hover",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-page",
