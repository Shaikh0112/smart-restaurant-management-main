...
function DashboardKpiCard({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-border bg-card p-4 motion-safe:transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg">
      {/* Icon + Label row */}
      <div className="flex items-center gap-2">
        <Icon size={18} strokeWidth={2} className="shrink-0 text-primary" aria-hidden="true" />
