      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden shadow-xs">
          <div className="min-w-[800px] w-full">
            <div className="grid grid-cols-[140px_1fr_120px_100px_80px_100px_100px] gap-4 bg-page px-6 py-3 border-b border-border">
            ...
            <div className="divide-y divide-border">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="grid grid-cols-[140px_1fr_120px_100px_80px_100px_100px] gap-4 items-center px-6 py-4">
                  <div className="skeleton h-4 w-24 rounded"></div>
  ...
  if (customer_reservations.length === 0) {
    return (
      <div className="flex flex-col items-center gap-3 py-16 text-text-secondary">
        <CalendarX size={18} className="opacity-40" />
