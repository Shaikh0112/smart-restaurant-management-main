...
export function CustomerBillRequestModal({
  ...
  return (
    <div
      className="fixed inset-0 z-40 flex items-center justify-center bg-black/65 backdrop-blur-xs p-4"
      role="dialog"
      aria-modal="true"
      ...
      <div className="relative flex w-full max-w-md flex-col gap-4 overflow-hidden rounded-3xl border border-border bg-card p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between border-b border-border pb-4">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-success/10 text-success border border-success/20">
              <Receipt size={18} />
            </div>
            <div>
        ...
        <div className="flex flex-col gap-2 rounded-2xl border border-warning/30 bg-warning/10 p-4 relative overflow-hidden">
            ...
            <button
              ...
              className={[
                ...
                isPlayingAudio
                  ...
                  : "bg-card text-warning border border-warning/30 hover:bg-warning/20",
              ].join(" ")}
            >
          ...
          <p className="text-xs font-semibold text-text-primary leading-relaxed mt-1">
            🎁 Enter your WhatsApp number to get <strong className="text-warning">10% Instant Loyalty Cashback</strong> + Exclusive Festival Offer Passes!
          </p>
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs font-bold text-text-secondary uppercase tracking-wider flex items-center justify-between">
            ...
            <span className="text-[10px] text-warning font-normal">Get Cashback & Bill Copy</span>
          </label>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-border bg-input py-3 pl-10 pr-4 text-sm font-semibold text-text-primary placeholder:text-text-disabled focus:border-success focus:outline-none focus:ring-1 focus:ring-success"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 mt-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-success-hover py-3 text-sm font-bold text-white shadow-md transition-all hover:bg-success active:scale-98 disabled:opacity-50"
          >
