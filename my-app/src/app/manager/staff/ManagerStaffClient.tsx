...
// RESPONSIBILITY: Owner Staff Page shell composing summary metrics, ManagerStaffTable, ManagerStaffSalaryModal, ManagerStaffAttendanceCalendarModal, and ManagerStaffSalaryPayslipModal.
// DATA FLOW: useManagerStaff → staff + salaryRecords + attendanceRecords → ManagerStaffTable & modals → paySalary & markAttendance

import { useState } from "react";
import { AuthGuard } from "@/app/auth/auth_components/AuthGuard";
import { useManagerStaff } from "@/app/manager/manager_hooks/useManagerStaff";
import { ManagerStaffTable } from "@/app/manager/manager_components/ManagerStaffTable";
import { ManagerStaffSalaryModal } from "@/app/manager/manager_components/ManagerStaffSalaryModal";
import { ManagerStaffAttendanceCalendarModal } from "@/app/manager/manager_components/ManagerStaffAttendanceCalendarModal";
import { ManagerStaffSalaryPayslipModal } from "@/app/manager/manager_components/ManagerStaffSalaryPayslipModal";
  ...
  return (
    <AuthGuard allowedRoles={["MANAGER"]}>
      <div className="flex flex-col gap-6">
        ...
        <ManagerStaffAttendanceCalendarModal
        ...
        <ManagerStaffSalaryPayslipModal
