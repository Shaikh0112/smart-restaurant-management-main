...
// DATA FLOW: ManagerStaffTable → ManagerStaffAttendanceCalendarModal → markAttendance → app_staff_attendance
...
interface ManagerStaffAttendanceCalendarModalProps {
  isOpen: boolean;
  staff: AppUser | null;
...
export function ManagerStaffAttendanceCalendarModal({
  isOpen,
  staff,
  attendanceRecords,
  onMarkAttendance,
  onClose,
}: ManagerStaffAttendanceCalendarModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fadeIn">
      <div className="w-full max-w-xl rounded-2xl bg-background/60 backdrop-blur-md border border-border/50 shadow-2xl overflow-hidden">
        {/* Modal Header */}
