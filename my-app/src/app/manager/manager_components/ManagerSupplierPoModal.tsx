...
// DATA FLOW: ManagerInventoryTable / inventory/page.tsx → ManagerSupplierPoModal → window.print()
...
interface ManagerSupplierPoModalProps {
  isOpen: boolean;
...
export function ManagerSupplierPoModal({
  isOpen,
  lowStockItems,
  onClose,
}: ManagerSupplierPoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fadeIn">
      <div className="w-full max-w-2xl rounded-2xl bg-background/60 backdrop-blur-md border border-border/50 shadow-2xl overflow-hidden max-h-[95vh] flex flex-col print:m-0 print:w-full print:max-w-none print:border-none print:shadow-none">
