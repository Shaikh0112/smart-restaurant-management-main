...
interface ManagerAddInventoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (item: Omit<AppInventoryItem, "id">) => void;
}

export function ManagerAddInventoryModal({ isOpen, onClose, onAdd }: ManagerAddInventoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-page/80 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-background/60 backdrop-blur-md border border-border/50 shadow-2xl">
