...
// DATA FLOW: ManagerStaffTable / ManagerStaffSalaryModal → ManagerStaffSalaryPayslipModal → window.print()
...
interface ManagerStaffSalaryPayslipModalProps {
  isOpen: boolean;
  staff: AppUser | null;
...
export function ManagerStaffSalaryPayslipModal({
  isOpen,
  staff,
  salaryRecord,
  onClose,
}: ManagerStaffSalaryPayslipModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fadeIn">
      ...
      <div className="w-full max-w-lg rounded-2xl bg-background/60 backdrop-blur-md border border-border/50 shadow-2xl overflow-hidden print:m-0 print:w-full print:max-w-none print:border-none print:shadow-none">
