...
// DATA FLOW: admin/qr/page.tsx → ManagerQrGenerator → canvas QR per AppTable

import { useEffect, useRef, useCallback } from "react";
import { Printer } from "lucide-react";
import type { ManagerQrGeneratorProps } from "@/app/manager/manager_types/ManagerTypes";
...
export function ManagerQrGenerator({ tables, tenantId }: ManagerQrGeneratorProps) {
