...
// Includes inline ManagerRecipeEditor for recipe ingredient linking.
// Pessimistic submit button with Loader2 spinner.
// DATA FLOW: admin/menu/page.tsx → ManagerMenuFormModal → onSave(values) → useManagerMenu
...
import { ManagerRecipeEditor } from "@/app/manager/manager_components/ManagerRecipeEditor";
import type { ManagerMenuFormModalProps, ManagerMenuFormValues } from "@/app/manager/manager_types/ManagerTypes";
 ...
 */
export function ManagerMenuFormModal({
  isOpen,
  editItem,
  inventoryItems,
  onSave,
  ...
  function onSubmit(values: ManagerMenuFormValues) {
    onSave(values);
    onClose();
  }
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg rounded-2xl bg-background/60 backdrop-blur-md border border-border/50 shadow-2xl"
