...
// DATA FLOW: ManagerMenuFormModal → ManagerRecipeEditor → onSave(recipe) → useManagerMenu.saveRecipe

import { useState } from "react";
import { Plus, Trash2 } from "lucide-react";
import type { AppMenuRecipeItem } from "@/types/appTypes";
import type { ManagerRecipeEditorProps } from "@/app/manager/manager_types/ManagerTypes";
 ...
 */
export function ManagerRecipeEditor({
  currentRecipe,
  inventoryItems,
  onSave,
}: ManagerRecipeEditorProps) {
