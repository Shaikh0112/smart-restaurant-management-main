...
// DATA FLOW: manager_reservations/page.tsx → ManagerReservationsFormModal → onSubmit → useManagerReservations.addReservation
...
import type {
  ManagerReservationsFormModalProps,
 ...
 */
export function ManagerReservationsFormModal({
  isOpen,
  availableTables,
  isSubmitting,
  onSubmit,
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<ManagerReservationsFormValues>({
  ...
  function handleFormSubmit(values: ManagerReservationsFormValues): void {
    onSubmit(values);
    onClose();
  }
