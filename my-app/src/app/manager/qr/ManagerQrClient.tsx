...
// Reads tables from localStorage, passes to ManagerQrGenerator.
// DATA FLOW: localStorage(app_tables) → ManagerQrGenerator → QR canvas grid

import { useEffect, useState } from "react";
import { ManagerQrGenerator } from "@/app/manager/manager_components/ManagerQrGenerator";
...
export default function ManagerQrClient() {
    ...
    <AuthGuard allowedRoles={["MANAGER"]}>
      <div className="flex flex-col gap-5">
        ...
        {!isMounted ? (
          ...
          <ManagerQrGenerator tables={tables} tenantId={tenantId} />
        )}
      </div>
    </AuthGuard>
  );
