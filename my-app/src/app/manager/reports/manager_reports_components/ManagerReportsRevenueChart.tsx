...
// DATA FLOW: useManagerReports → manager_reports/page.tsx → ManagerReportsRevenueChart → ApexCharts → UI

import dynamic from "next/dynamic";
import type { ManagerReportsRevenueChartProps } from "@/app/manager/reports/manager_reports_types/ManagerReportsTypes";
 ...
 *
 * @param dailyRevenue - Array of 30 ManagerReportsDailyStat entries from useManagerReports
 */
export function ManagerReportsRevenueChart({ dailyRevenue }: ManagerReportsRevenueChartProps) {
