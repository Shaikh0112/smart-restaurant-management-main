...
// RESPONSIBILITY: ManagerReports & Analytics page shell.
// Composes ManagerReportsSummaryCards + ManagerReportsRevenueChart + ManagerReportsTopItemsTable.
// All data logic delegated to useManagerReports hook.
// isMounted guard prevents SSR/client hydration mismatch.
// DATA FLOW: useManagerReports â†’ summary + topItems + dailyRevenue
//            â†’ ManagerReportsSummaryCards + ManagerReportsRevenueChart + ManagerReportsTopItemsTable â†’ UI

import { useState, useEffect } from "react";
import { Download } from "lucide-react";
import { useManagerReports } from "@/app/manager/reports/manager_reports_hooks/useManagerReports";
import { ManagerReportsSummaryCards } from "@/app/manager/reports/manager_reports_components/ManagerReportsSummaryCards";
import { ManagerReportsRevenueChart } from "@/app/manager/reports/manager_reports_components/ManagerReportsRevenueChart";
import { ManagerReportsTopItemsTable } from "@/app/manager/reports/manager_reports_components/ManagerReportsTopItemsTable";
import { AuthGuard } from "@/app/auth/auth_components/AuthGuard";
import type { ManagerReportsPeriod } from "@/app/manager/reports/manager_reports_types/ManagerReportsTypes";

// â”€â”€â”€ Constants (Rule 35: No magic strings) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

const PAGE_TITLE    = "ManagerReports & Analytics"                    as const;
const PAGE_SUBTITLE = "Sales performance and revenue insights" as const;

const PERIOD_TABS: { label: string; value: ManagerReportsPeriod }[] = [
...
export default function ManagerReportsClient() {
  ...
  const { summary, topItems, dailyRevenue, period, customDate, setPeriod, setCustomDate, exportCsv } = useManagerReports();

  // â”€â”€ Skeleton â€” shown before client mounts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (!isMounted) {
    return (
      <div className="flex flex-col gap-6">
        <ManagerReportsPageHeader
          period={period}
  ...
  return (
    <AuthGuard allowedRoles={["MANAGER"]}>
      <div className="flex flex-col gap-6">
        ...
        {/* KPI Summary Cards */}
        <ManagerReportsSummaryCards summary={summary} />

        {/* Revenue Trend Chart â€” last 30 days (always full range) */}
        <ManagerReportsRevenueChart dailyRevenue={dailyRevenue} />

        {/* Top Items Table â€” scoped to selected period */}
        <ManagerReportsTopItemsTable topItems={topItems} />
      </div>
    </AuthGuard>
  );
}
...
interface ManagerReportsPageHeaderProps {
  period: ManagerReportsPeriod;
  customDate: string;
  onPeriodChange: (p: ManagerReportsPeriod) => void;
  onCustomDateChange: (d: string) => void;
  onExport: () => void;
}

function ManagerReportsPageHeader({
  period,
  customDate,
  onPeriodChange,
  onCustomDateChange,
  onExport,
}: ManagerReportsPageHeaderProps) {
  return (
