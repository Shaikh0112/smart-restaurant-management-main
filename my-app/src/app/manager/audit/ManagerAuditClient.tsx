...
// Reads audit logs from localStorage and renders ManagerAuditLogTable.
// DATA FLOW: useLocalStorage(AUDIT_LOGS) → ManagerAuditLogTable → UI

import { useEffect, useState } from "react";
import { useLocalStorage } from "@/hooks/useLocalStorage";
import { STORAGE_KEYS } from "@/lib/localStorageSeeder";
import { ManagerAuditLogTable } from "@/app/manager/manager_components/ManagerAuditLogTable";
...
export default function ManagerAuditClient() {
  ...
  return (
    <AuthGuard allowedRoles={["MANAGER"]}>
      <div className="flex flex-col gap-5">
        <AuditPageHeader />
        <ManagerAuditLogTable auditLogs={auditLogs} />
      </div>
    </AuthGuard>
  );
}
