...
const registerSchema = z.object({
  name: z.string().min(1, "Owner Full Name is required"),
  phone: z.string().min(1, "Mobile Phone Number is required"),
  email: z.string().email("Invalid email address").min(1, "Business Email Address is required"),
