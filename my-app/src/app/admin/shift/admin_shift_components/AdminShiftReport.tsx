    ...
    <div className="flex flex-col gap-6" id="shift-z-report">
      ...
      <div className="flex justify-end print:hidden">
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-border px-4 py-2 text-[13px] font-semibold text-text-secondary hover:bg-card motion-safe:transition-colors"
        >
          <Printer size={15} />
          Print Z-Report
        </button>
