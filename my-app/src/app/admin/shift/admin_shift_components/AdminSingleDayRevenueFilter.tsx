...
import type { AdminSingleDayRevenueFilterProps } from "@/app/admin/admin_types/AdminTypes";
...
export function AdminSingleDayRevenueFilter({ salesHistory }: AdminSingleDayRevenueFilterProps): React.JSX.Element {
  ...
  }, [selectedDate, pathname, router, searchParams, todayStr]);
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="rounded-lg border border-border bg-input py-2 pl-9 pr-3 text-xs font-semibold text-text-primary focus:border-border-focus focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            />
          </div>
          <button
