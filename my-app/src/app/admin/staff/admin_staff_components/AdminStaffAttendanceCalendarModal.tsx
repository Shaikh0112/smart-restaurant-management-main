      ...
      <div className="w-full max-w-xl rounded-2xl border border-border bg-card shadow-2xl overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl border border-border bg-page p-3.5">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="rounded-lg border border-border bg-input px-3 py-1.5 text-xs font-semibold text-text-primary focus:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              />
              <button
                type="button"
                onClick={handleMarkAllPresent}
                className="rounded-lg bg-primary/10 px-3 py-1.5 text-xs font-semibold text-primary hover:bg-primary/20 motion-safe:transition-all"
              >
                Mark All Present
              </button>
            </div>
              ...
              {Array.from({ length: daysInMonth }).map((_, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center rounded-xl p-2 h-14 motion-safe:transition-all hover:scale-105 shadow-xs ${bgClass}`}
                  >
        ...
        <div className="flex justify-end border-t border-border bg-page px-6 py-4">
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl bg-primary px-6 py-2.5 text-xs font-bold text-white shadow-md hover:bg-primary-hover motion-safe:transition-all"
          >
