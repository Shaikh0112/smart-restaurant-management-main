        ...
        <tbody className="divide-y divide-border">
          {staffList.map((staff) => {
            ...
            return (
              <tr
                key={staff.id}
                className="group hover:bg-surface-hover/50 motion-safe:transition-colors"
              >
                ...
                <td className="px-5 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button
                      ...
                      className="flex items-center gap-1.5 rounded-lg bg-primary px-3 py-1.5 text-[12px] font-semibold text-white shadow-xs hover:bg-primary-hover active:scale-95 motion-safe:transition-all"
                    >
                      <Banknote size={14} />
                    ...
                    <div className="relative inline-block text-left">
                      <button
                        ...
                        className="p-1.5 rounded-lg text-text-secondary hover:bg-border motion-safe:transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                      >
                        ...
                        <>
                          ...
                          <div className="absolute right-0 top-10 z-20 w-48 rounded-xl border border-border bg-card p-1 shadow-lg flex flex-col gap-0.5">
                            <button
                              ...
                              className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-[12px] font-medium text-text-primary hover:bg-surface-hover motion-safe:transition-colors"
                            >
