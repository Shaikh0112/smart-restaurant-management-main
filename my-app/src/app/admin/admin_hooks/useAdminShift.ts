...
import { FetchState, type AppShiftRegister, type AppSalesRecord } from "@/types/appTypes";
 ...
 *
 * @returns shift, isOpen, fetchState, salesHistory, openShift, closeShift
 */
export function useAdminShift(): UseAdminShiftReturn {
  ...
  return { shift, isOpen, fetchState, salesHistory, openShift, closeShift };
}
