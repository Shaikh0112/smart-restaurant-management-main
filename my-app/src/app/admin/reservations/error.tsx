// RESPONSIBILITY: Error boundary for Admin Reservations
"use client";
...
export default function AdminReservationsError({
  ...
  useEffect(() => {
    ...
    console.error("AdminReservations Error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full p-6 text-center animate-in fade-in zoom-in-95 duration-500">
      ...
      <h2 className="text-2xl font-bold text-text-primary mb-2">Failed to Load Reservations</h2>
