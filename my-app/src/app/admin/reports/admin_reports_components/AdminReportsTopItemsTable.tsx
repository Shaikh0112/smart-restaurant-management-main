        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative w-full sm:w-48">
            ...
            <input
              ...
              className="w-full rounded-md border border-border bg-input py-1.5 pl-8 pr-3 text-xs text-text-primary placeholder:text-text-disabled focus:border-border-focus focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            />
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <select
              ...
              className="rounded-md border border-border bg-input px-2 py-1.5 text-xs font-medium text-text-primary focus:border-border-focus focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
