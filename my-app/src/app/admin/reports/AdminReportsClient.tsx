...
// DATA FLOW: useAdminReports --- summary + topItems + dailyRevenue
        ...
        {period === "CUSTOM" && (
          <div className="flex items-center gap-2 rounded-lg border border-primary bg-primary/10 px-3 py-1.5">
            ...
            <input
              ...
              className="rounded-md border border-border bg-input px-2 py-1 text-xs font-bold text-text-primary focus:border-border-focus focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            />
          </div>
        )}
      </div>
