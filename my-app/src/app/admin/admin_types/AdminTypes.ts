...
import type { AppMenuItem, AppCombo, AppInventoryItem, KitchenStation, AppUser, AppSalaryRecord, AppStaffAttendanceRecord, AttendanceStatus, AppSalesRecord, AppShiftRegister, FetchState } from "@/types/appTypes";
