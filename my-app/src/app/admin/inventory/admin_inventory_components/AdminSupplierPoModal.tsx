      ...
      <div className="w-full max-w-2xl rounded-2xl border border-border bg-card shadow-2xl overflow-hidden max-h-[95vh] flex flex-col print:m-0 print:w-full print:max-w-none print:border-none print:shadow-none">
        ...
        <div className="flex items-center justify-between border-b border-border bg-surface-hover/30 px-6 py-4 print:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-white shadow-xs hover:bg-primary-hover active:scale-95 motion-safe:transition-all"
            >
              <Printer size={14} />
        ...
        <div className="flex justify-end gap-3 border-t border-border bg-page px-6 py-4 print:hidden">
          <button
            onClick={onClose}
            className="rounded-xl border border-border px-5 py-2 text-xs font-semibold text-text-secondary hover:bg-surface-hover motion-safe:transition-colors"
          >
            Close
          </button>
          <button
            onClick={handlePrint}
            className="flex items-center gap-1.5 rounded-xl bg-primary px-5 py-2 text-xs font-bold text-white shadow-md hover:bg-primary-hover motion-safe:transition-all active:scale-95"
          >
            <Printer size={14} />
