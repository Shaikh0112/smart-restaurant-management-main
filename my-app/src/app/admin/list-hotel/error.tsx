// RESPONSIBILITY: Error boundary for Admin ListHotel
"use client";

import React, { useEffect } from "react";
import { AlertTriangle, RefreshCcw } from "lucide-react";

export default function AdminListHotelError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("AdminListHotel Error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full p-6 text-center animate-in fade-in zoom-in-95 duration-500">
      ...
      <h2 className="text-2xl font-bold text-text-primary mb-2">Failed to Load ListHotel</h2>
