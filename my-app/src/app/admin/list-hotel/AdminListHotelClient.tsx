"use client";
// RESPONSIBILITY: Client-side orchestrator for AdminListHotel.
...
export function AdminListHotelClient() {
  return (
    <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto p-4 md:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-text-primary tracking-tight">Hotel Listings</h1>
          <p className="text-sm text-text-secondary mt-1">Manage hotel listings and view related analytics.</p>
        </div>
      </div>
