...
export function AuthLoginForm({ onSuccessRedirect }: AuthLoginFormProps): React.JSX.Element {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>, overrideUser?: string, overridePass?: string) => {
    e.preventDefault();
          ...
          {[
            ...
            <button
              ...
              onClick={() => {
                ...
                // Immediate submission with overrides to prevent stale state closure
                const formEvent = { preventDefault: () => {} } as React.FormEvent<HTMLFormElement>;
                handleSubmit(formEvent, btn.user, btn.pass);
              }}
